...
exports.OE_MD_ACCORDION_PROVIDERS = [
    OEAccordionService
];
var OE_MD_AccordionModule = (function () {
    function OE_MD_AccordionModule() {
    }
    OE_MD_AccordionModule = __decorate([
        core_1.NgModule({
            ...
            exports: [exports.OE_MD_ACCORDION_DIRECTIVES]
        })
    ], OE_MD_AccordionModule);
    return OE_MD_AccordionModule;
}());
exports.OE_MD_AccordionModule = OE_MD_AccordionModule;
