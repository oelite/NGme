...
var OEHttpModule = (function () {
    function OEHttpModule() {
    }
    OEHttpModule = __decorate([
        core_1.NgModule({
            imports: [common_1.CommonModule, http_1.HttpModule, core_2.CookieService],
...
exports.OEHttpModule = OEHttpModule;
