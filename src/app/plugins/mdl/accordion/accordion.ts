 ...
 */
import {
    Component, OnInit, Input, ElementRef, ChangeDetectionStrategy, Injectable, EventEmitter,
    ViewEncapsulation, NgModule
} from '@angular/core';
...
export const OE_ACCORDION_DIRECTIVES = [
    OEAccordionGroupComponent, OEAccordionItemComponent, OEAccordionComponent
];
export const OE_ACCORDION_PROVIDERS = [
    OEAccordionService
];
